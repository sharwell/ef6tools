...
namespace Microsoft.Data.Entity.Design.Base.Context
{
    ...
    /// </summary>
    internal abstract class ContextItemCollection : IEnumerable<ContextItem>
    {
        /// <summary>
        ...
        internal abstract bool Contains(Type itemType);

        /// <summary>
        ///     Removes an entry from the ContextItemCollection.
        /// </summary>
        /// <param name="itemType"></param>
        /// <returns></returns>
        internal abstract bool Remove(Type itemType);
        ...
        /// <returns>True if the context contains an instance of this item type.</returns>
        internal bool Contains<TItemType>() where TItemType : ContextItem
        {
        ...
        internal abstract ContextLayer CreateLayer();
        ...
        /// <exception cref="ArgumentNullException">if itemType is null.</exception>
        internal abstract ContextItem GetValue(Type itemType);
        ...
        /// <returns>A context item of the requested type.  If there is no item in the context of this type a default one will be created.</returns>
        internal TItemType GetValue<TItemType>() where TItemType : ContextItem
        {
        ...
        internal abstract void SetValue(ContextItem value);
        ...
        internal void Subscribe<TContextItemType>(SubscribeContextCallback<TContextItemType> callback) where TContextItemType : ContextItem
        {
            if (callback == null)
            {
        ...
        /// <exception cref="ArgumentNullException">if callback is null.</exception>
        internal void Unsubscribe<TContextItemType>(SubscribeContextCallback<TContextItemType> callback)
        ...
        /// <param name="callback">The callback to remove.</param>
        /// <exception cref="ArgumentNullException">if contextItemType or callback is null.</exception>
        internal abstract void Unsubscribe(Type contextItemType, SubscribeContextCallback callback);
